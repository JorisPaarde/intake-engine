...
> **Documentversie:** 2.1 · **Laatste update:** 2026-07-21 · Onderhoud: zie [AGENTS.md](../AGENTS.md)
...
De knop **Start demo** staat **standaard aan** (`DEMO_ENABLED` default `true`). Elke bezoeker kan zonder account een tijdelijke airco-intake starten. Optioneel in `shared/.env`:
