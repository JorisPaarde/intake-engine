...
6. Een notitie hoeft geen foto te hebben. Bij een foto kan AI alleen een korte, beslisrelevante constatering voorstellen; die wordt pas een gezaghebbende installateurswaarneming nadat de installateur haar bevestigt of aanpast. Bij onvoldoende beeld kan hij **Vraag nieuwe foto** als vooraf ingevulde klanttaak openen, controleren en versturen; hetzelfde geldt voor ontbrekende ruimte- of route-informatie vanuit het onderdelenoverzicht (BL-100). AI-uitzonderingen houden een snelle 1-klik-variant.
