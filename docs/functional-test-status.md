...
> **Documentversie:** 1.42 · **Laatste update:** 2026-08-05 · Onderhoud: zie [AGENTS.md](../AGENTS.md)
...
| Interactieve installateursdemo (BL-001) | todo | - | Na deploy als gast: homepage → **Probeer de demo** → welkomstpopup → vooringevulde *Nieuwe opname* → rolkeuze i.p.v. mail. Test beide paden (verkorte klantwizard én zelf/werkplek + *Toon voorbeelddossier* + klanttaak activeren). Desktop én 390 px, toetsenbord, geen consolefouten, geen mail/AI/PDF. |
