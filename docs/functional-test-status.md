...
> **Documentversie:** 1.23 · **Laatste update:** 2026-07-21 · Onderhoud: zie [AGENTS.md](../AGENTS.md)
...
| Publieke demo “Start demo” (BL-001) | todo | - | Na deploy (demo standaard aan): knop op `/`, redirect `/o/{token}`, watermerk, bedankt-copy. Als `shared/.env` nog `DEMO_ENABLED=false` heeft: op `true` of verwijderen + `config:cache`. |
