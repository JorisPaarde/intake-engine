...
> **Documentversie:** 1.64 · **Laatste update:** 2026-09-03 · Onderhoud: zie [AGENTS.md](../AGENTS.md)
...
| Installateurstaal multi-split/singles + v14 (BL-082) | todo | - | Sectie **Multi-split of singles**; sticky **Kies multi-split of singles** / **Nog geen keuze**; plaatsingsveld **Notitie**; demo-marker **Demo** zonder boost/echte werkplek/Voorbeeldroute; **je**; nieuwe opname pin’t airco v14 (korte kruipruimte-/matenlabels). |
...
| Demo opslaan zonder login-bounce (BL-091) | todo | - | In publieke demo op dossierdetail: Adres opnieuw / AI-aandachtspunten / Beoordeling opslaan blijft in de demo (geen `/login`, geen 404). Werkplek Ruimte opslaan idem. Verlopen/gepurgede demo → `/demo/beeindigd`, niet installateurslogin. |
