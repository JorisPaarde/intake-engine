...
|-----------|--------|-----------|----------|
| Create Alvast invullen = 1 tekstveld (BL-093) | todo | - | Na deploy: *Nieuwe opname* toont **Alvast invullen** met alleen **Korte uitleg bij de aanvraag**; geen koelen/ruimtes/kruipruimte/L×B×H-prefill; na tekst + opslaan vult intent-afleiding wat kan. |
