...
|-----------|--------|-----------|----------|
| Demo-welkom productuitleg (BL-095) | todo | - | Na deploy: **Probeer de demo** → popup **Zo werkt de Digitale Opname** met aanvraag/eigen woorden/AI-aanvullen/offerte-zonder-voorbezoek; CTA **Start met nieuwe opname** → create. |
