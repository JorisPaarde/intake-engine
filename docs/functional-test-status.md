...
|-----------|--------|-----------|----------|
| Create Alvast invullen = 1 tekstveld (BL-093) | todo | - | Na deploy: *Nieuwe opname* toont **Alvast invullen** met alleen **Wat vroeg de klant?** (installateurstaal); geen koelen/ruimtes/kruipruimte/L×B×H-prefill; na tekst + opslaan vult intent-afleiding wat kan. |
