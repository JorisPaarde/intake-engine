...
|-----------|--------|-----------|----------|
| Create zonder Alvast invullen (BL-093) | todo | - | Na deploy: *Nieuwe opname* toont geen blok **Alvast invullen** / geen prefill-velden (reden, koelen, kruipruimte, L×B×H); adres/klant/opslaan blijven; demo create werkt nog. |
