...
| Begeleide leidingroute — klant-wizard (BL-029) | todo | - | Nog te bouwen: klant markeert binnenunit-positie → beoordeling → steeds één vervolgfoto-instructie → samengevatte route. |
