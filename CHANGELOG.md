...
- **Besloten productmodel voor de volgende fase:** `docs/product-model.md`, ADR-0011 en ADR-0012 leggen de opname vast als centraal technisch dossier na een bestaande aanvraag. Klant, installateur, AI en openbare bronnen vullen hetzelfde dossier; volledig klant-, volledig installateur- en hybride opname zijn volwaardige workflows; sterke afleidingen worden zonder veld-voor-veld-bevestiging gebruikt; airco krijgt gewenste ruimtes, kandidaatopstellingen en afzonderlijke koel-, condens- en stroomverbindingen.
- **Uitvoerplan BL-035 t/m BL-042:** gefaseerde migratiebrug, beslisgereed dossier, installateur-only-flow, afgebakende klanttaken, airco-opstellingen, drie verbindingen, AI-uitzonderingsreview en uitkomstmetrics. Huidige implementatie en doelmodel zijn in alle geraakte docs expliciet gescheiden.
...
- BL-029/ADR-0009 zijn herijkt. De geleverde stateful routebackend en Terra/Sol-modeltiering blijven behouden, maar de nog niet gebouwde globale route-UI vervalt. ADR-0012/BL-040 koppelen routeanalyse pas na kandidaatopstellingen aan één concrete koel-, condens- of stroomverbinding.
