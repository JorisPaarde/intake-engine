...
- `docs/backlog.md` v3.22 + `docs/intake-engine.md` v1.8 + README v1.20 + AGENTS.md v1.5: BL-025 → `done` (wizard request-caching); band J volledig afgerond; tip over Livewire private request-caches.
