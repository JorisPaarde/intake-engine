...
**MVP-fasen 1–6 afgerond en gemerged naar `main`** (t/m AI-samenvatting). Open werk: [docs/backlog.md](docs/backlog.md). PHP-uploadlimieten op staging ok (BL-003 done). BL-018 vraag-voor-vraag + BL-017 airco-template v2 (minder vragen). BL-001 demo-pad (`DEMO_ENABLED`). Volgende high: BL-002 hertest afronden, BL-016 prefill. Handmatige teststatus: [docs/functional-test-status.md](docs/functional-test-status.md).
