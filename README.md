...
**MVP-fasen 1–6 afgerond en gemerged naar `main`** (t/m AI-samenvatting). Open werk staat in [docs/backlog.md](docs/backlog.md); hoogste prioriteit is de functionele hertest van Fase 3–6 op staging (BL-002) en afronden van PHP-uploadlimieten op staging (BL-003: `.user.ini` + bevestigen via `/health`). Handmatige teststatus: [docs/functional-test-status.md](docs/functional-test-status.md).
