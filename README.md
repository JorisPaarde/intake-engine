...
**MVP-fasen 1–6 afgerond en gemerged naar `main`** (t/m AI-samenvatting). Staging functioneel hertest: BL-002/BL-003 **done** (AI-samenvatting blocked bij `AI_PROVIDER=null`). Open werk: [docs/backlog.md](docs/backlog.md). Handmatige teststatus: [docs/functional-test-status.md](docs/functional-test-status.md).
