...
**MVP-fasen 1–6 afgerond en gemerged naar `main`** (t/m AI-samenvatting). Open werk: [docs/backlog.md](docs/backlog.md). PHP-uploadlimieten op staging ok (BL-003 done). BL-018 vraag-voor-vraag klantflow gedaan (één vraag per scherm). BL-001 demo-pad (`DEMO_ENABLED`). Volgende high: BL-017 (minder vragen) + BL-002 hertest. Handmatige teststatus: [docs/functional-test-status.md](docs/functional-test-status.md).
