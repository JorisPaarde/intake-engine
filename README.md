...
**MVP-fasen 1–6 afgerond en gemerged naar `main`** (t/m AI-samenvatting). Open werk: [docs/backlog.md](docs/backlog.md). Recent code: BL-006/BL-007 AI (aandachtspunten-voorstellen + lokale fotokwaliteit; externe `openai`-client standaard uit tot DPIA + key), BL-023 auto-doorgaan na keuze, BL-021 foto multiselect, BL-024 installateursgalerij, BL-014/015 mail, BL-005 PDF, BL-009 purge. BL-001 demo: code klaar — open **host/env-acties** (SMTP, `DEMO_ENABLED`, domein/SSL) in [docs/DEPLOYMENT.md § Handmatige acties](docs/DEPLOYMENT.md#handmatige-acties-producteigenaar). Volgende high: BL-011 (eigen domein/SSL); band J vervolg BL-022. Handmatige teststatus: [docs/functional-test-status.md](docs/functional-test-status.md).
